...
require __DIR__.'/../../../pomocServicesAPI/vendor/autoload.php';



//$service = getOneService($_POST['id']);
...
$client = array(
    ...
    "mail" => $_POST['mail'],
    "portable" => "",
    "address" => $_POST['address'] . " " . $_POST['postalCode'] . " " . $_POST['city'],
...
$pdf->pdf->SetSubject('Devis' . $_POST['service']);
